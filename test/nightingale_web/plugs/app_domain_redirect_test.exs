defmodule NightingaleWeb.AppDomainRedirectTest do
  @moduledoc """
  Tests for NightingaleWeb.AppDomainRedirect
  """
  use NightingaleWeb.ConnCase, async: true
  alias NightingaleWeb.AppDomainRedirect
  ...
  test "redirects from bad hostname when active" do
    port = get_in(Application.get_env(:nightingale, NightingaleWeb.Endpoint), [:http, :port])
